			...
			<div class="col-xs-12 col-sm-offset-1 col-sm-10">
				...
				<div class="col-xs-12">
					<form action="result.php" method="GET">
						<div class="form-group has-warning has-feedback">
							...
							<input name="q" type="text" class="form-control search-box" id="inputSuccess2" value="<?php echo htmlspecialchars($keywords); ?>">
				...
				<div class="col-xs-12">
					...
					<div class="panel panel-warning">
						<!-- Hasil Penelusuran -->
				 		<div class="panel-heading">Hasil penelusuran untuk "<?php echo htmlspecialchars($keywords); ?>" - <?php echo $results; ?> ditemukan</div>
						...
						<div class="panel-footer">
							<div class="text-center">
								<ul class="pagination">
									<?php
										if ($page > 0)
											echo sprintf('<li><a href="result.php?q='.$keywords.'&p=%d">&laquo;</a></li>', $page-1);
										$awal = $page-4;
										if ($awal < 0) $awal = 0;
										for ($i = $awal; $i < $maxPage && $i < $awal+9; ++$i) {
											if ($i == $page)
												...
												echo sprintf('<li><a href="result.php?q='.$keywords.'&p=%d">%d</a></li>', $i, $i+1);
										}
										if ($page < $maxPage-1)
											echo sprintf('<li><a href="result.php?q='.$keywords.'&p=%d">&raquo;</a></li>', $page+1);
									?>
								</ul>
							</div>
						</div>
